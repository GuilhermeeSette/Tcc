import cv2
from from FaceRecognizerFromEyesRegion.calculator import *
...
def train(faces, test_face):
  ...
  projection_weigths = equation7(hotelling_transform, mean_face)
  reconstructed_face = equation8(hotelling_transform, projection_weights, mean_face)
